 ...
 * This algorithm places the smallest job times ahead of the larger job times.
 * @author nah14
 * @see uk.ac.aber.rcs.cs211.schedulersim.Simulator
 *
 */
public class PrioritySmallest implements Scheduler {

	protected ArrayList<Job> queue;
	private int numberOfJobs;
	private boolean inserted;
	
	public PrioritySmallest () {
	...
	public void addNewJob(Job job) throws SchedulerException {
		...
		*/
		...
		//Get the jobs that don't fit our previous criteria and add them.
		if(!inserted){
			this.queue.add(job);
		}
		this.numberOfJobs++;
