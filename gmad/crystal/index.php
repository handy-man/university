...
$SteamAPIKey = "DF2B6BA0B8A5D543678B2C029FDEE71A";
...
<html>
	...
	<meta name="description" content="GmadGaming.net" /> <!-- Webpage Description --> 
	<title>GmadGaming.net Loading</title> <!-- Webpage Title -->
    ...
    <div class="core-wrapper"><!-- Opens the wrapper so we can contain and center everything -->
        ...
        <img src="images/logo2.png" width="960" height="120" title="GmadGaming.net Logo" /><!-- This adds in the logo, simply change logo.png to make this look different -->
        ...
        <div id="right-items"><!-- Open wrapper for the items on the right -->
            ...
            <ul id="rules">
                ...
                <li><span>2</span> Do not ghost</li>
                <li><span>3</span> Be nice and have fun</li>
                <li><span>4</span> Do not hack or exploit</li>
                <li><span>5</span> Do not micspam</li>
                <li><span>6</span> Obey all staff orders - No Admin Disrespect</li>
                <li><span>7</span> Thanks, and have fun!</li>
                <li><span>8</span> Community Owners:</li>
                <li><span>9</span> Nascar</li>
                <li><span>10</span> Banana )(at</li>
            </ul>
