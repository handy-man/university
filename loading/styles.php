...
div#site_title_2
{
	...
	background-color:rgba(<?PHP echo $title_red . ", " . $title_green . ", " . $title_blue; if ($opaque_enabled == true) {echo ", 0.0";} else { echo ", 1";}?>);
	font-weight: bold;
	font-size: 100px;
	
	margin: 0 auto 100px 650px;
	<?PHP
	if ($custom_font_1 == true){
	echo "font-family: titleFont;";
	}
	else{
	echo "font-family: 'Arial';";
